...
def preprocess():
    ...
    video_path = os.path.join('path_to_save_uploaded_videos', uploaded_file.filename)
    uploaded_file.save(video_path)
    # Assuming a function name from preprocess_video_square.py to preprocess the video
...
def split():
    ...
    image_path = os.path.join('path_to_save_uploaded_images', uploaded_file.filename)
    uploaded_file.save(image_path)
    # Assuming a function name from split_aged_tiled_image_square.py to split the image
